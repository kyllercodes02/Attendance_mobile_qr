...
class _AttendanceApiService implements AttendanceApiService {
  ...
  Future<AttendanceScanResponseModel> scanAttendance(
    ...
    final _options = _setStreamType<AttendanceScanResponseModel>(
    ...
    late AttendanceScanResponseModel _value;
    try {
      _value = AttendanceScanResponseModel.fromJson(_result.data!);
    } on Object catch (e, s) {
